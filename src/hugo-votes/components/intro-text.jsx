...
const VoteIntroText = () => (
  <CardText className="vote-intro" style={{ padding: '16px 32px' }}>
    ...
    <p>
      If you have questions regarding the ballot, please contact <a href="mailto:hugohelp@chicagoworldcon.org">hugohelp@chicagoworldcon.org</a>.
    </p>
    ...
    <p>
      ...
      have any questions regarding the packet, please contact <a href="mailto:hugohelp@chicagoworldcon.org">hugohelp@chicagoworldcon.org</a>.
    </p>
    <p>
