...
const contents = {
  ...
  all: {
    ...
    body: <div>
      <p>
        ...
        A <b>Supporting</b> membership of An Unnamed Chicago 2022 Worldcon - grants you the right to
  ...
  daypass: {
    ...
    body: <div>
      <p>
        If you are only able to come to An Unnamed Chicago 2022 Worldcon - for a day or two, we have
  ...
  support: {
    ...
    body: <div>
      <p>
        A non-attending membership of An Unnamed Chicago 2022 Worldcon - which will grant you the right
