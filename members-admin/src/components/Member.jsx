...
export default class Member extends React.Component {
  ...
  static membershipTypes = [ 'NonMember', 'Exhibitor', 'Supporter', 'Backer', 'BackerVoter', 'Voter', 'Friend', 'Infant', 'Child', 'YoungAdult', 'FirstWorldcon', 'Adult', 'BidSupporter', 'BidFriend', 'BidStar' ];
